...
- Java & Spring, AWS 기반의 서버 백엔드 개발자로 '멋쟁이사자처럼대학 커뮤니티 플랫폼' BE 피플 리드와 '항공대 청원서비스' 개발 프로젝트에 백엔드 리드로 참여하고 있습니다.

- 테스트 코드의 중요성을 항상 느끼며, 프로젝트에서 테스트 코드 커버리지를 50% 이상 확보하기 위해 노력하고 있습니다.
